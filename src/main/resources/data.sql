...
INSERT INTO users (user_id, email, first_name, last_name, password, role_id, user_status_id) VALUES (1,'martavoloshyn73@gmail.com','Марта','Волошин','$2a$10$lotmb.YAQL6OOQunoV55WOINatJrVJsJIrzSOU5hpAJF/hGbOef/u',1,1),(2,'annkozak@gmail.com','Anna','Kozak','pass',2,1),(3,'nastyapyshyeva@gail.com','Anastasia','Pyshyeva','pass',3,1);
...
INSERT INTO unavailable_dates (unavailable_date_id, end_date, start_date, performer_id) VALUES (1,'2021-02-25 00:00:00','2021-02-18 00:00:00',2),(2,'2021-03-05 00:00:00','2021-03-04 00:00:00',2);
...
INSERT INTO orders (order_id, comment, end_date, start_date, customer_id, order_status_id, performer_id) VALUES (1,'Замовлення 1','2021-02-18 00:00:00','2021-02-13 00:00:00',1,4,2),(2,'Замовлення 2','2021-01-29 00:00:00','2021-01-27 00:00:00',1,7,2);
INSERT INTO feedbacks (feedback_id, date, stars, text, order_id) VALUES (1,'2021-02-07 12:43:32',5,'Чудовий догляд за твариною!', 2);
